...
# Step 3: Delete Kubernetes controllers (Karpenter, Load Balancer Controller, ESO) Helm charts
log_step "Step 3/6 : Deleting Kubernetes controllers (Load Balancer Controller, ExternalDNS, Karpenter, ESO) Helm charts..."
